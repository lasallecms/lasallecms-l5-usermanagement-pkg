...
<head>
    ...
    <link media="all" type="text/css" rel="stylesheet" href="{{{ Config::get('app.url') }}}/{{{ Config::get('lasallecms.public_folder') }}}/packages/usermanagement/admin/login/default/login.css" >
</head>
    ...
    <div id="loginbox" style="margin-top:200px;" class="mainbox col-md-6 col-md-offset-3 col-sm-8 col-sm-offset-2">
        ...
        <div class="panel panel-info" >
            ...
            <div class="panel-heading">
                <div class="panel-title">Sign In to the {{{ Config::get('lasallecms.site_name') }}} Administration</div>
            </div>
